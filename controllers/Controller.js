...
const checkoutpayement = (req, res) => {
  console.log(req.body);
  console.log("Received request in checkoutpayement");
  try {
    const params = {
      submit_type: 'pay',
      mode: 'payment',
...
// Controller function to calculate total price and total quantity
const updateTotal = async function calculateTotal(req, res) {
  try {
    ...
    const result = await pMod.invoiceSchema.aggregate(pipeline);
...
const findUserByPartialMatch = (req, res) => {
  ...
  module.exports={
                    ...
                    countClients,getSumOfPricesToday,calculateTotalPriceuserlocal,updateTotal,
